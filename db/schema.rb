...
ActiveRecord::Schema[7.0].define(version: 2022_09_13_211226) do
  ...
  create_table "assignaments", force: :cascade do |t|
    ...
    t.index ["insurance_id"], name: "index_assignaments_on_insurance_id"
  end
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.index ["status_id"], name: "index_roles_on_status_id"
  end
  ...
  add_foreign_key "assignaments", "insurances"
